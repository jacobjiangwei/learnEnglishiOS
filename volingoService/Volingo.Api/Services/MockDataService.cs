...
/// </summary>
public class MockDataService : ISubmitResultService
{
    ...
    // ── ISubmitResultService ──

    Task ISubmitResultService.SubmitAsync(string deviceId, SubmitRequest request)
    {
        Submit(deviceId, request);
        return Task.CompletedTask;
    }

    Task<StatsResponse> ISubmitResultService.GetStatsAsync(string deviceId, int days)
        => Task.FromResult(GetStats(deviceId, days));
